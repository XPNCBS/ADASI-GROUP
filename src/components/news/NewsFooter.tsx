    ...
    <footer className="news-footer">
      <div className="news-footer-grid">
        <div>
          ...
          <div className="news-subscribe-row">
            <input
              ...
              className="news-form-input news-subscribe-input"
            />
            <NewsButton className="news-subscribe-button">
              Подписаться
            </NewsButton>
          </div>
        ...
        <div className="news-footer-info">
          <div>
            🏢 Компания: ADASI GROUP SDN BHD / Пн - Пт: 10:00 - 18:00 /
            info@adasigroup.com
          </div>
          <div>
            📍 Адрес: N-05-03, Pusat Perdagangan, Bandar Bukit Jalil,
